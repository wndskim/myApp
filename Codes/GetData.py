...
def DART_재무정보():
    ...
    # df=pd.DataFrame(dart.finstate('삼성전자', 2022, reprt_code='11013')) # 1분기=>11013, 반기=>11012, 3분기=>11014, 사업보고서=>11011
    df=pd.DataFrame(dart.finstate_all('삼성전자', 2023)) # 1분기=>11013, 반기=>11012, 3분기=>11014, 사업보고서=>11011
